...
namespace Infinium
{
    public partial class AddZOVNewsForm : Form
    {
        Infinium.ZOVNews LightNews;
        ...
        public AddZOVNewsForm(ref Infinium.ZOVNews tLightNews, ref Form tTopForm)
        {
            InitializeComponent();
        ...
        public AddZOVNewsForm(ref Infinium.ZOVNews tLightNews, int SenderTypeID, string HeaderText, string BodyText, int iNewsID, DateTime dDateTime, ref Form tTopForm)
        {
            InitializeComponent();
