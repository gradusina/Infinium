...
namespace Infinium
{
    public partial class ClientsMessagesForm : InfiniumForm
    {
        ...
        {
            ConnectClientMessage.CheckOnline();
        ...
        {
            ConnectClientMessage.AddUserToSelected(UsersListDataGrid.SelectedRows[0].Cells["ClientID"].Value.ToString());
        }
        ...
        private void SelectedUsersGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                ConnectClientMessage.RemoveCurrent();
        ...
        private void SelectedUsersGrid_SelectionChanged(object sender, EventArgs e)
        {
            ...
            ConnectClientMessage.ClearCurrentUpdates();

            ConnectClientMessage.FillMessages(Convert.ToInt32(((DataRowView)ConnectClientMessage.SelectedUsersBindingSource.Current)["ClientID"]));
            NameLabel.Text = ((DataRowView)ConnectClientMessage.SelectedUsersBindingSource.Current)["ClientName"].ToString();

            messagesContainer1.AddDataClient(Convert.ToInt32(((DataRowView)ConnectClientMessage.SelectedUsersBindingSource.Current)["ClientID"]));
        ...
        private void SendButton_Click(object sender, EventArgs e)
        {
            ...
            ConnectClientMessage.AddMessage((Convert.ToInt32(((DataRowView)ConnectClientMessage.SelectedUsersBindingSource.Current)["ClientID"])), richTextBox1.Text.TrimEnd());
            messagesContainer1.AddDataClient((Convert.ToInt32(((DataRowView)ConnectClientMessage.SelectedUsersBindingSource.Current)["ClientID"])));
            richTextBox1.Clear();
        }
        ...
        {
            ConnectClientMessage.GetNewMessages();
        ...
        {
            if (ConnectClientMessage == null)
                return;

            if (kryptonCheckSet1.CheckedButton.Name == "UsersFilterOnline")
                ConnectClientMessage.ClientBindingSource.Sort = "OnlineStatus DESC";

            if (kryptonCheckSet1.CheckedButton.Name == "UsersFilterAlpha")
                ConnectClientMessage.ClientBindingSource.Sort = "ClientName ASC";
        }
