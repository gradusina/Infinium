...
namespace Infinium.Modules.ZOV.Complaints
{
    public class ComplaintsManager
    {
        ...
        private SqlCommandBuilder UpdateComplaintsCB = null;
        ...
        {
            string SelectCommand = @"SELECT TOP 0 * FROM Complaints";
            ComplaintsDT = new DataTable();
            UpdateComplaintsDA = new SqlDataAdapter(SelectCommand, ConnectionStrings.ZOVOrdersConnectionString);
            UpdateComplaintsDA.Fill(ComplaintsDT);
            UpdateComplaintsCB = new SqlCommandBuilder(UpdateComplaintsDA);
            ...
            using (SqlDataAdapter DA = new SqlDataAdapter("SELECT TOP 0 * FROM FrontsOrders", ConnectionStrings.ZOVOrdersConnectionString))
            {
                ...
                FrontsOrdersDT.Columns.Add("Reason", System.Type.GetType("System.String"));
            }
            ...
            using (SqlDataAdapter DA = new SqlDataAdapter("SELECT TOP 0 * FROM DecorOrders", ConnectionStrings.ZOVOrdersConnectionString))
            {
                ...
                DecorOrdersDT.Columns.Add("Reason", System.Type.GetType("System.String"));
            }
            ...
            ComplaintTypesDT = new DataTable();
            using (SqlDataAdapter DA = new SqlDataAdapter("SELECT * FROM ComplaintTypes", ConnectionStrings.ZOVReferenceConnectionString))
            {
                DA.Fill(ComplaintTypesDT);
            }

            ComplaintsBS = new BindingSource();
        ...
        {
            ComplaintsBS.DataSource = ComplaintsDT;
        ...
        public DataGridViewComboBoxColumn ComplaintTypesColumn
        {
            get
            {
                DataGridViewComboBoxColumn Column = new DataGridViewComboBoxColumn()
                {
                    Name = "ComplaintTypesColumn",
                    HeaderText = "Тип",
                    DataPropertyName = "ComplaintTypeID",
                    DataSource = new DataView(ComplaintTypesDT),
                    ValueMember = "ComplaintTypeID",
                    DisplayMember = "ComplaintType",
                    DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing,
                    AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells,
                    MinimumWidth = 150
                };
        ...
        public DataGridViewComboBoxColumn DecorProductColumn
        {
            get
            {
                DataGridViewComboBoxColumn Column = new DataGridViewComboBoxColumn();
        ...
        public DataGridViewComboBoxColumn DecorItemColumn
        {
            get
            {
                DataGridViewComboBoxColumn Column = new DataGridViewComboBoxColumn();
        ...
        public DataGridViewComboBoxColumn DecorColorColumn
        {
            get
            {
                DataGridViewComboBoxColumn Column = new DataGridViewComboBoxColumn();
        ...
        public string CurrentClientName
        {
            get
            {
                sClientName = string.Empty;
                if (iClientID != 0)
                {
                    DataRow[] rows = ClientsDT.Select("ClientID=" + iClientID);
                    if (rows.Count() > 0)
                        sClientName = rows[0]["ClientName"].ToString();
                }
                return sClientName;
            }
        }

        public string CurrentDocNumber
        {
        ...
        {
            get { return dDispatchDate; }
            set { dDispatchDate = value; }
        }
        ...
        {
            get { return iMainOrderID; }
            set { iMainOrderID = value; }
        }

        public void ConfirmComplaint(int ComplaintID, bool ConfirmComplaint, int ConfirmPercentage)
        {
            using (SqlDataAdapter DA = new SqlDataAdapter("SELECT * FROM Complaints WHERE ComplaintID=" + ComplaintID, ConnectionStrings.ZOVOrdersConnectionString))
            {
                using (SqlCommandBuilder CB = new SqlCommandBuilder(DA))
                {
                    using (DataTable DT = new DataTable())
                    {
                        ...
                        if (DT.Rows.Count > 0)
                        {
                            DT.Rows[0]["ConfirmComplaint"] = ConfirmComplaint;
                            DT.Rows[0]["ConfirmPercentage"] = ConfirmPercentage;
                            DA.Update(DT);
                        }
                    }
                }
        ...
        {
            using (SqlDataAdapter DA = new SqlDataAdapter("SELECT * FROM ComplaintFronts WHERE ComplaintID=" + ComplaintID, ConnectionStrings.ZOVOrdersConnectionString))
            {
                using (SqlCommandBuilder CB = new SqlCommandBuilder(DA))
                {
                    using (DataTable DT = new DataTable())
            ...
            using (SqlDataAdapter DA = new SqlDataAdapter("SELECT * FROM ComplaintDecor WHERE ComplaintID=" + ComplaintID, ConnectionStrings.ZOVOrdersConnectionString))
            {
                using (SqlCommandBuilder CB = new SqlCommandBuilder(DA))
                {
                    using (DataTable DT = new DataTable())
        ...
        {
            string SelectCommand = @"SELECT * FROM Complaints";
            ComplaintsDT.Clear();
            if (SelectComplaintsDA == null)
                SelectComplaintsDA = new SqlDataAdapter(SelectCommand, ConnectionStrings.ZOVOrdersConnectionString);
            SelectComplaintsDA.SelectCommand.CommandText = SelectCommand;
            SelectComplaintsDA.Fill(ComplaintsDT);
        }

        public bool FilterFrontsOrdersByMainOrderID(int ComplaintID, int MainOrderID)
        {
            ...
            using (SqlDataAdapter DA = new SqlDataAdapter("SELECT * FROM ComplaintFronts WHERE ComplaintID=" + ComplaintID,
                ConnectionStrings.ZOVOrdersConnectionString))
            {
                using (DataTable DT = new DataTable())
                {
                    ...
                    if (DT.Rows.Count > 0)
                    {
                        foreach (DataRow Row in DT.Rows)
                        {
                            DataRow[] ORow = OriginalFrontsOrdersDT.Select("FrontsOrdersID = " + Row["FrontsOrdersID"]);
                            if (ORow.Count() == 0)
                                continue;
        ...
        public bool FilterDecorOrdersByMainOrderID(int ComplaintID, int MainOrderID)
        {
            ...
            DecorOrdersDT.Clear();
            using (SqlDataAdapter DA = new SqlDataAdapter("SELECT * FROM ComplaintDecor WHERE ComplaintID=" + ComplaintID,
                ConnectionStrings.ZOVOrdersConnectionString))
            {
                using (DataTable DT = new DataTable())
                {
                    ...
                    if (DT.Rows.Count > 0)
                    {
                        foreach (DataRow Row in DT.Rows)
                        {
                            DataRow[] ORow = OriginalDecorOrdersDT.Select("DecorOrderID = " + Row["DecorOrderID"]);
                            if (ORow.Count() == 0)
                                continue;
        ...
        public void MoveToComplaint(int ComplaintID)
        {
            ComplaintsBS.Position = ComplaintsBS.Find("ComplaintID", ComplaintID);
        }

        public void FilterComplaints(bool bWithReturn, bool bWithoutReturn, bool bNotFullyDispatch, bool bConfirm, bool bNotConfirm)
        {
            string ComplaintTypeFilter = string.Empty;
            string ConfirmComplaintFilter = string.Empty;
            if (bWithReturn)
            {
                if (ComplaintTypeFilter.Length > 0)
                    ComplaintTypeFilter += " OR (ComplaintTypeID = 1)";
                else
                    ComplaintTypeFilter = " (ComplaintTypeID = 1)";
            }
            if (bWithoutReturn)
            {
                if (ComplaintTypeFilter.Length > 0)
                    ComplaintTypeFilter += " OR (ComplaintTypeID = 2)";
                else
                    ComplaintTypeFilter = " (ComplaintTypeID = 2)";
            }
            if (bNotFullyDispatch)
            {
                if (ComplaintTypeFilter.Length > 0)
                    ComplaintTypeFilter += " OR (ComplaintTypeID = 3)";
                else
                    ComplaintTypeFilter = " (ComplaintTypeID = 3)";
            }
            ...
            if (bConfirm)
            {
                if (ConfirmComplaintFilter.Length > 0)
                    ConfirmComplaintFilter += " OR (ConfirmComplaint = 1)";
                else
                    ConfirmComplaintFilter = " (ConfirmComplaint = 1)";
            }
            if (bNotConfirm)
            {
                if (ConfirmComplaintFilter.Length > 0)
                    ConfirmComplaintFilter += " OR (ConfirmComplaint = 0)";
                else
                    ConfirmComplaintFilter = " (ConfirmComplaint = 0)";
            }

            if (ConfirmComplaintFilter.Length > 0)
            {
                ConfirmComplaintFilter = "(" + ConfirmComplaintFilter + ")";
                if (ComplaintTypeFilter.Length > 0)
                    ComplaintTypeFilter = ComplaintTypeFilter + " OR " + ConfirmComplaintFilter;
                else
                    ComplaintTypeFilter = ConfirmComplaintFilter;
            }
            if (ComplaintTypeFilter.Length == 0)
                ComplaintTypeFilter = "ComplaintTypeID=0";
            ComplaintsBS.Filter = ComplaintTypeFilter;
        }
    ...
    public class FrontsReportToDBF
    {
        ...
        {
            //IsNonStandard = Convert.ToBoolean(Rows[r]["IsNonStandard"]);
            ...
            for (int i = 0; i < Fronts.Rows.Count; i++)
            {
                ...
                //ЛЮКС, МЕГА
                filter = " AND InsetTypeID IN (860,862)";
                Rows = OrdersDataTable.Select("FrontID = " + Fronts.Rows[i]["FrontID"].ToString() + " AND (Width <> -1)" + filter + IsNonStandardFilter);
                for (int r = 0; r < Rows.Count(); r++)
                {
                    if (GetMeasureType(Convert.ToInt32(Rows[r]["FrontConfigID"])) == 3)
        ...
        public void Report(int ComplaintID, DateTime DispatchDate)
        {
            ProfilFrontsOrdersDataTable.Clear();
            TPSFrontsOrdersDataTable.Clear();
            DecorInvNumbersDT.Clear();

            DataTable EditFrontsOrdersDT = new DataTable();
            DataTable OriginalFrontsOrdersDT = new DataTable();
            using (SqlDataAdapter DA = new SqlDataAdapter(@"SELECT FrontsOrders.*, infiniu2_catalog.dbo.FrontsConfig.AccountingName, infiniu2_catalog.dbo.FrontsConfig.InvNumber FROM FrontsOrders
                ...
                WHERE FrontsOrdersID IN (SELECT FrontsOrdersID FROM ComplaintFronts WHERE ComplaintID = " + ComplaintID + ")", ConnectionStrings.ZOVOrdersConnectionString))
            {
                DA.Fill(OriginalFrontsOrdersDT);
            }
            EditFrontsOrdersDT = OriginalFrontsOrdersDT.Clone();
            EditFrontsOrdersDT.Columns.Add("Reason", System.Type.GetType("System.String"));
                ...
                using (DataTable DT = new DataTable())
                {
                    ...
                    if (DT.Rows.Count > 0)
                    {
                        foreach (DataRow Row in DT.Rows)
                        {
                            ...
                            if (ORow.Count() == 0)
                                continue;
                            DataRow NewRow = EditFrontsOrdersDT.NewRow();
                            NewRow.ItemArray = ORow[0].ItemArray;
                            NewRow["Count"] = Row["Count"];
                            NewRow["Reason"] = Row["Reason"];
                            EditFrontsOrdersDT.Rows.Add(NewRow);
                        }
                    }
                }
            }
            OriginalFrontsOrdersDT.Dispose();
            EditFrontsOrdersDT.Dispose();

            ProfilFrontsOrdersDataTable = EditFrontsOrdersDT.Clone();
            TPSFrontsOrdersDataTable = EditFrontsOrdersDT.Clone();

            SplitTables(EditFrontsOrdersDT, ref ProfilFrontsOrdersDataTable, ref TPSFrontsOrdersDataTable);
    ...
    public class DecorReportToDBF
    {
        ...
        private void Create()
        {
            ...
            using (SqlDataAdapter DA = new SqlDataAdapter(@"SELECT TOP 0 DecorOrders.*, infiniu2_catalog.dbo.DecorConfig.AccountingName, infiniu2_catalog.dbo.DecorConfig.InvNumber FROM DecorOrders
                INNER JOIN infiniu2_catalog.dbo.DecorConfig ON DecorOrders.DecorConfigID = infiniu2_catalog.dbo.DecorConfig.DecorConfigID", ConnectionStrings.ZOVOrdersConnectionString))
            {
                DA.Fill(DecorOrdersDataTable);
                DecorOrdersDataTable.Columns.Add("Reason", System.Type.GetType("System.String"));
            }
        }
        ...
        public void Report(int ComplaintID)
        {
            DataTable OriginalDecorOrdersDT = new DataTable();
            using (SqlDataAdapter DA = new SqlDataAdapter(@"SELECT DecorOrders.*, infiniu2_catalog.dbo.DecorConfig.AccountingName, infiniu2_catalog.dbo.DecorConfig.InvNumber FROM DecorOrders
                ...
                WHERE DecorOrderID IN (SELECT DecorOrderID FROM ComplaintDecor WHERE ComplaintID = " + ComplaintID + ")", ConnectionStrings.ZOVOrdersConnectionString))
            {
                DA.Fill(OriginalDecorOrdersDT);
            }
    ...
    public class ReportToDBF
    {
        ...
        public void Collect(decimal Rate, bool IsNonStandard)
        {
            ...
            for (int i = 0; i < DistinctInvNumbersDT.Rows.Count; i++)
            {
                ...
                DataRow[] InvRows = ProfilReportTable.Select("InvNumber = '" + InvNumber + "'" + IsNonStandardFilter);
                if (InvRows.Count() == 1)
                {
                    ...
                    //    InvRows[0]["NonStandardMargin"] = ExtraPrice = Convert.ToDecimal(InvRows[0]["NonStandardMargin"]);
                    //}
                    InvRows[0]["UNN"] = UNN;
            ...
            for (int i = 0; i < DistinctInvNumbersDT.Rows.Count; i++)
            {
                ...
                DataRow[] InvRows = TPSReportTable.Select("InvNumber = '" + InvNumber + "'" + IsNonStandardFilter);
                if (InvRows.Count() == 1)
                {
                    Count = Convert.ToDecimal(InvRows[0]["Count"]);
                    Cost = Convert.ToDecimal(InvRows[0]["Cost"]) * Rate / 1.2m;
        ...
        public void CreateReport(DateTime DispatchDate, int ComplaintID, int CurrencyType)
        {
            ClearReport();
            ...
            if (CurrencyType == 5)
            {
                ...
                Rate = GetEURBYRCurrency(NbrbBankData).ToString();
                Currency = "BYN";
            ...
            FrontsReport.Report(ComplaintID, DispatchDate);
            DecorReport.Report(ComplaintID);
            ...
            decimal TotalCost = (TotalProfil + TotalTPS);
