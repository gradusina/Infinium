...
namespace Infinium
{
    public partial class MarketingPackagesPrintProfilForm : Form
    {
        const int eHide = 2;
        const int eShow = 1;
        const int eClose = 3;
        ...
        const int BarcodeType = 3;//Упаковка. ЗОВ. ТПС
        ...
        public MarketingPackagesPrintProfilForm(LightStartForm tLightStartForm)
        {
            InitializeComponent();
