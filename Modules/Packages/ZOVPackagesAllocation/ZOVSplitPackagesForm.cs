...
namespace Infinium
{
    public partial class ZOVSplitPackagesForm : Form
    {
        const int eHide = 2;
        const int eShow = 1;
        const int eClose = 3;
        ...
        Infinium.Modules.Packages.ZOV.SplitStruct SS;
        ...
        public void SetSplitPositions(int Count, ref Infinium.Modules.Packages.ZOV.SplitStruct tSS)
        {
            TotalCount = Count;
            SS = tSS;
        }
