...
namespace Infinium
{
    public partial class ZOVPackagesAllocTPSForm : Form
    {
        const int eHide = 2;
        const int eShow = 1;
        const int eClose = 3;
        ...
        const string PackAllocStatusID = "TPSPackAllocStatusID";
        ...
        public ZOVPackagesAllocTPSForm(LightStartForm tLightStartForm)
        {
            InitializeComponent();
