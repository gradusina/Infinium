...
namespace Infinium
{
    public partial class FrontsPictureEditForm : Form
    {
        const int eHide = 2;
        const int eShow = 1;
        const int eClose = 3;
        ...
        FrontsCatalog FrontsCatalog;

        int FrontID;

        public FrontsPictureEditForm(ref FrontsCatalog tDecorCatalog, int iFrontID)
        {
            InitializeComponent();

            FrontsCatalog = tDecorCatalog;
            FrontID = iFrontID;

            this.MaximumSize = Screen.PrimaryScreen.WorkingArea.Size;

            pbFullImage.Image = FrontsCatalog.GetPicture(FrontID);
        ...
        {
            FrontsCatalog.SetPicture(pbFullImage.Image, FrontID);
