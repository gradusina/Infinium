...
namespace Infinium
{
    public partial class CatalogZOVPriceForm : Form
    {
        const int eHide = 2;
        const int eShow = 1;
        const int eClose = 3;
        ...
        private void CatalogZOVPriceForm_Shown(object sender, EventArgs e)
        {
            while (!SplashForm.bCreated) ;
            FormEvent = eShow;
        ...
        private void FrontsCatalogBinding()
        {
            ...
            FrontsZOVPriceDataGrid.DataSource = FrontsCatalog.ZOVPriceBindingSource;
        ...
        private void FrontsGridsSettings()
        {
            ...
            FrontsZOVPriceDataGrid.Columns["MeasureID"].Visible = false;

            FrontsZOVPriceDataGrid.Columns["ZOVRetailPrice"].HeaderText = "Розница";
            FrontsZOVPriceDataGrid.Columns["ZOVNonStandMargin"].HeaderText = "Наценка, %";
            FrontsZOVPriceDataGrid.Columns["Measure"].HeaderText = "";
            ...
            FrontsZOVPriceDataGrid.Columns["ZOVRetailPrice"].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            FrontsZOVPriceDataGrid.Columns["ZOVRetailPrice"].MinimumWidth = 15;
            FrontsZOVPriceDataGrid.Columns["ZOVNonStandMargin"].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            FrontsZOVPriceDataGrid.Columns["ZOVNonStandMargin"].MinimumWidth = 60;
            FrontsZOVPriceDataGrid.Columns["Measure"].AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            FrontsZOVPriceDataGrid.Columns["Measure"].Width = 45;
            FrontsZOVPriceDataGrid.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
        ...
        public void GetFrontsZOVPrice()
        {
            ...
            FrontsCatalog.FilterCatalogZOVRetailPrice(FrontName, ColorID, TechnoColorID, PatinaID, InsetTypeID, InsetColorID, TechnoInsetTypeID, -1, Height, Width);
        }
        ...
        public void DecorCatalogBinding()
        {
            ...
            DecorZOVPriceDataGrid.DataSource = DecorCatalog.ZOVPriceBindingSource;
        ...
        public void GetDecorZOVPrice()
        {
            if (DecorCatalog.WidthBindingSource.Count > 0)
            {
                ...
                DecorCatalog.FilterCatalogZOVPrice(((DataRowView)DecorCatalog.DecorItemBindingSource.Current)["Name"].ToString(),
                    Convert.ToInt32(((DataRowView)DecorCatalog.ItemColorsBindingSource.Current)["ColorID"]), 
                    Convert.ToInt32(((DataRowView)DecorCatalog.ItemPatinaBindingSource.Current)["PatinaID"]),
                    Convert.ToInt32(((DataRowView)DecorCatalog.ItemInsetTypesBindingSource.Current)["InsetTypeID"]),
